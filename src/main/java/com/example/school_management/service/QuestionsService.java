...
public class QuestionsService {
    ...
    public ResponseDTO getQuestionById(final String id) {
    ...
    public QuestionDTO getQuestionsById(final String id) {
    ...
    public ResponseDTO deleteQuestion(final String id) {
